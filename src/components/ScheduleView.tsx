...
export const ScheduleView: React.FC<ScheduleViewProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="scroll-reveal bg-white dark:bg-[#131d2e] rounded-2xl border border-slate-200 dark:border-slate-800 p-6 sm:p-8 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6">
          ...
          {/* 1. Bandagi Card */}
          <div className="scroll-reveal scroll-reveal-delay-1 rounded-2xl p-6 bg-gradient-to-b from-amber-50/70 to-white dark:from-amber-950/20 dark:to-slate-900/40 border border-amber-200/80 dark:border-amber-900/40 space-y-4 hover:shadow-md transition-shadow">
          ...
          {/* 2. Morning Dua Card */}
          <div className="scroll-reveal scroll-reveal-delay-2 rounded-2xl p-6 bg-gradient-to-b from-teal-50/70 to-white dark:from-teal-950/20 dark:to-slate-900/40 border border-teal-200/80 dark:border-teal-900/40 space-y-4 hover:shadow-md transition-shadow">
          ...
          <div className="scroll-reveal scroll-reveal-delay-3 rounded-2xl p-6 bg-gradient-to-b from-indigo-50/70 to-white dark:from-indigo-950/20 dark:to-slate-900/40 border border-indigo-200/80 dark:border-indigo-900/40 space-y-4 hover:shadow-md transition-shadow">
            ...
            <div className="pt-3 border-t border-indigo-200/60 dark:border-indigo-800/40 space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="text-lg font-bold text-slate-800 dark:text-slate-100">7:30 PM</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-xs text-slate-600 dark:text-slate-300 font-semibold">Mon – Thu, Sat & Sun:</span>
                <span className="text-lg font-bold text-slate-800 dark:text-slate-100">7:00 PM</span>
              </div>
            </div>
          </div>
        ...
        <div className="mt-6 pt-5 border-t border-slate-100 dark:border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <button
            ...
            className="inline-flex items-center space-x-2 px-4 py-2 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 text-xs font-semibold transition-all cursor-pointer"
          >
